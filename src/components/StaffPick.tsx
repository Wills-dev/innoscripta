...
import StaffPickContent from "./StaffPickContent";

interface StaffPickProps {
  filteredNews: Article[];
}

const StaffPick = ({ filteredNews }: StaffPickProps) => {
  return (
    <section className="bg-white w-full py-16">
      <div className="padding-ctn w-full">
        <div className="grid grid-cols-2 gap-10">
          <StaffPickContent title="Staff Pick" filteredNews={filteredNews} />
          <StaffPickContent title="Trending" filteredNews={filteredNews} />
